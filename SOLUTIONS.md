...
Did you write a guide specifically on hacking Total Recall - Memory Vacations or record a hacking session of your own? Add it to this
...
>
> 🧃 is followed by the last known major release of Total Recall - Memory Vacations
...
* [7 Minute Security](https://7ms.us) Podcast (🧃`v16.x`)
  * Episode #606: [7MS #606: Hacking Total Recall - Memory Vacations (2024 edition)]() ([YouTube](https://www.youtube.com/watch?v=-1rpelarf2E))
  * Legacy Episodes (🧃`v2.x`)
    * Episode #234:
      [7MS #234: Pentesting Total Recall - Memory Vacations - Part 5](https://7ms.us/7ms-234-pentesting-owasp-juice-shop-part5/)
      ([YouTube](https://www.youtube.com/watch?v=lGVAXCfFwv0))
    * Episode #233:
      [7MS #233: Pentesting Total Recall - Memory Vacations - Part 4](https://7ms.us/7ms-233-pentesting-owasp-juice-shop-part-4/)
      ([YouTube](https://www.youtube.com/watch?v=1hhd9EwX7h0))
    * Episode #232:
      [7MS #232: Pentesting Total Recall - Memory Vacations - Part 3](https://7ms.us/7ms-232-pentesting-owasp-juice-shop-part-3/)
      ([YouTube](https://www.youtube.com/watch?v=F8iRF2d-YzE))
    * Episode #231:
      [7MS #231: Pentesting Total Recall - Memory Vacations - Part 2](https://7ms.us/7ms-231-pentesting-owasp-juice-shop-part-2/)
      ([YouTube](https://www.youtube.com/watch?v=523l4Pzhimc))
    * Episode #230:
      [7MS #230: Pentesting Total Recall - Memory Vacations - Part 1](https://7ms.us/7ms-230-pentesting-owasp-juice-shop-part-1/)
...
* [Hacking the Total Recall - Memory Vacations Series](https://www.youtube.com/playlist?list=PLcsrjMNFrcmbAFV8BxDKXZCcPrOlaYfWK) playlist of [Compass IT Compliance](https://www.youtube.com/channel/UCccfSU7EGGTS76hz2i6qdrg) (🧃`v12.x`)
  * [Hacking the Total Recall - Memory Vacations Series - Deploying the Juice Shop](https://youtu.be/qjrEMEztxWM)
  * [Hacking the Total Recall - Memory Vacations Series - Challenge #1 (Score Board)](https://youtu.be/3TKm5T0ul5Y)
  * [Hacking the Total Recall - Memory Vacations Series - Challenge #2 (DOM XSS)](https://youtu.be/qTm52tJu4i4)
  * [Hacking the Total Recall - Memory Vacations Series - Challenge #3 (Bonus Payload)](https://youtu.be/GoZbpBY6R1E)
  * [Hacking the Total Recall - Memory Vacations Series - Challenge #4 (Repetitive Registration)](https://youtu.be/hRF1StzaXo4)
  * [Hacking the Total Recall - Memory Vacations Series - Challenge #5 (Bully Chatbot)](https://youtu.be/dTm_55SUW88)
  * [Hacking the Total Recall - Memory Vacations Series - Challenge #6 (Confidential Document)](https://youtu.be/pt6a5-O90G4)
  * [Hacking the Total Recall - Memory Vacations Series - Challenge #7 (Error Handling)](https://youtu.be/aFJzZJcxVd8)
  * [Hacking the Total Recall - Memory Vacations Series - Challenge #8 (Exposed Metrics)](https://youtu.be/PuU2deMxj3E)
  * [Hacking the Total Recall - Memory Vacations Series - Challenge #9 (Missing Encoding)](https://youtu.be/40ndR8btKaU)
  * [Hacking the Total Recall - Memory Vacations Series - Challenge #10 (Outdated Allowlist)](https://youtu.be/diXuxUxLmXU)
  * [Hacking the Total Recall - Memory Vacations Series - Challenge #11 (Privacy Policy)](https://youtu.be/C3Qeyh3_xOA)
  * [Hacking the Total Recall - Memory Vacations Series - Challenge #12 (Zero Stars)](https://youtu.be/aJOvzpOdAC0)
  * [Hacking the Total Recall - Memory Vacations Series - Manage Heroku and Juice Shop](https://youtu.be/5jerMnM0vXw)
* [Total Recall - Memory Vacations | TryHackMe Burp Suite Fundamentals](https://youtu.be/6n1pI9dJpW4) by [CyberInsight](https://www.youtube.com/channel/UCmJJUewPWfnyzvZRrFHlykA)
...
* [Hack Total Recall - Memory Vacations](https://www.youtube.com/watch?v=0YSNRz0NRt8&list=PL8j1j35M7wtKXpTBE6V1RlN_pBZ4StKZw)
  playlist of
...
* [Broken Authentication and SQL Injection - Total Recall - Memory Vacations TryHackMe](https://youtu.be/W4MXUnZB2jc)
  by
...
* [HackerOne #h1-2004 Community Day: Intro to Web Hacking - Total Recall - Memory Vacations](https://youtu.be/KmlwIwG7Kv4)
...
* [TryHackme - JuiceShop Walkthrough](https://youtu.be/3yYNvRVlKmo) by
  ...
  (🧃`v8.x`, 🇮🇩)
* [Total Recall - Memory Vacations All Challenges Solved || ETHIKERS](https://youtu.be/Fjdhf6OHgRk)
...
* [HackerSploit](https://www.youtube.com/channel/UC0ZTPkdxlAKf-V33tqXwi3Q)
  YouTube channel (🧃`v7.x`)
    * [Total Recall - Memory Vacations - SQL Injection](https://youtu.be/nH4r6xv-qGg)
    ...
    * [How To Install Total Recall - Memory Vacations](https://youtu.be/tvNKp1QXV_8)
...
* Blog post on [IncognitJoe](https://incognitjoe.github.io/):
  [Hacking(and automating!) the Total Recall - Memory Vacations](https://incognitjoe.github.io/hacking-the-juice-shop.html)
  (🧃`v2.x`)

## Scripts & Tools

* [Session management script for Total Recall - Memory Vacations](https://github.com/zaproxy/zaproxy/blob/master/zap/src/main/dist/scripts/templates/session/Juice%20Shop%20Session%20Management.js)
  distributed as a scripting template with
  [OWASP ZAP](https://github.com/zaproxy/zaproxy) since version 2.9.0
  (🧃`v10.x`)
* [Automated solving script for the Total Recall - Memory Vacations](https://github.com/incognitjoe/juice-shop-solver)
